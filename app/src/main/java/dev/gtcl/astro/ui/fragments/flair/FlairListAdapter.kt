...
class FlairListAdapter(private val flairSelectionListener: FlairSelectionListener) :
    ListAdapter<Flair, FlairVH>(DiffCallback) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FlairVH =
        FlairVH.create(parent)
